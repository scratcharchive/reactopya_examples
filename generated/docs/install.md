...
Install the reactopya_examples Python package:

```
pip install reactopya_examples==0.5.2
```
...
```
import reactopya_examples
reactopya_examples.init_jupyter()
```
...
```
import reactopya_examples
reactopya_examples.init_electron()
```
...
Now you should be able to `import reactopya_examples` as in the example notebook
...
To open the gallery of reactopya_examples widgets as a web server, follow the instructions for a development installation above, and then:
